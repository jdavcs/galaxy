...
def test_get_displayable_roles__display_names(session, make_role, make_user_and_role):
    ...
    admin_role1 = make_role(type="admin", name="admin-role1")
    ...
    assert roles[0].displayed_name == "user1@example.com"
    assert roles[1].displayed_name == "user2@example.com"
    assert roles[2].displayed_name == "user3@example.com"
    assert roles[3].displayed_name == "admin-role1"  # displays role name by default
