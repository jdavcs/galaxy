...
#        pass # TODO can I test this?
        ...
        def test_default_database_connection(self): #TODO fails
...
#
#    #def test_default_involucro_path(self): #TODO fails
...
#
##    def test_default_shed_tool_data_path(self): #TODO fails
...
#
#    #def test_default_dynamic_proxy_golang_api_key(self): #TODO fails
...
##
#    #def test_default_logging(self): #TODO fails
...
##
#    #def test_default_heartbeat_log(self): #TODO fails
...
##
#    #def test_default_statsd_host(self): #TODO fails
...
#
#    #def test_default_library_import_dir(self): #TODO fails
#    #    assert self._app.config.library_import_dir is None
#
#    #def test_default_user_library_import_dir(self):  TODO
...
##
#    # def test_default_user_library_import_symlink_whitelist(self): TODO
...
##
#    #def test_default_disable_library_comptypes(self): #TODO fails
...
#
#    #def test_default_admin_users(self): #TODO fails
...
#
#    #def test_default_api_allow_run_as(self): #TODO fails
#    #    assert self._app.config.api_allow_run_as is None
#
#    #def test_default_master_api_key(self): #TODO fails
...
#
#    #def test_default_tool_filters(self): #TODO fails
#    #    assert self._app.config.tool_filters is None
#
#    #def test_default_tool_label_filters(self):  #TODO fails
#    #    assert self._app.config.tool_label_filters is None
#
#    #def test_default_tool_section_filters(self): #TODO fails
...
#
#    #def test_default_persistent_communication_rooms(self): #TODO fails
