...
class UploadsTestCase(SeleniumTestCase, UsesHistoryItemAssertions):
    ...
    def test_upload_pasted_content(self):
        ...
        self.history_panel_click_item_title(hid=1, wait=True)
        self.assert_item_body_includes(1, pasted_content)
    ...
    def test_upload_pasted_url_content(self):
        ...
        self.history_panel_click_item_title(hid=1, wait=True)
        self.assert_item_body_includes(1, "Copyright")
...
#PRJD#A60709  SAMD00016379    DRX000475   ftp.sra.ebi.ac.uk/vol1/fastq/DRR000/DRR000770/DRR000770.fastq.gz
#PRJD#A60709  SAMD00016383    DRX000476   ftp.sra.ebi.ac.uk/vol1/fastq/DRR000/DRR000771/DRR000771.fastq.gz
#PRJD#A60709  SAMD00016380    DRX000477   ftp.sra.ebi.ac.uk/vol1/fastq/DRR000/DRR000772/DRR000772.fastq.gz
#PRJD#A60709  SAMD00016378    DRX000478   ftp.sra.ebi.ac.uk/vol1/fastq/DRR000/DRR000773/DRR000773.fastq.gz
#PRJD#A60709  SAMD00016381    DRX000479   ftp.sra.ebi.ac.uk/vol1/fastq/DRR000/DRR000774/DRR000774.fastq.gz
#PRJD#A60709  SAMD00016382    DRX000480   ftp.sra.ebi.ac.uk/vol1/fastq/DRR000/DRR000775/DRR000775.fastq.gz"""
    #    )
