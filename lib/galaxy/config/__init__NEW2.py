...
class GalaxyAppConfiguration(BaseAppConfiguration):
    ...
    def _create_attributes_from_raw_config(self):
        #for key, value in self._raw_config.items(): # TODO next step: just loop!
        #    setattr(self, key, value)

        # the following is ONLY reading from kwargs (or using a default) and assigning to a new instance variable.
        # ANY FURHER PROCESSING is in _process_config and is left intact.
        self.migrated_tools_config = kwargs.get('migrated_tools_conf', 'migrated_tools_conf.xml')
        self.shed_tool_conf = kwargs.get('shed_tool_conf', 'shed_tool_conf.xml')
        self.check_migrate_databases = kwargs.get('check_migrate_databases', True)
        self.database_create_tables = kwargs.get("database_create_tables", "True")
        self.database_query_profiling_proxy = kwargs.get("database_query_profiling_proxy", "False")
        ...
        self.slow_query_log_threshold = kwargs.get("slow_query_log_threshold", 0)
        self.enable_per_request_sql_debugging = kwargs.get("enable_per_request_sql_debugging", "False")
        self.database_auto_migrate = kwargs.get("database_auto_migrate", "False")
        self.install_database_connection = kwargs.get("install_database_connection", None)
        self.database_wait = kwargs.get("database_wait", "False")
        self.database_wait_attempts = kwargs.get("database_wait_attempts", 60)
        self.database_wait_sleep = kwargs.get("database_wait_sleep", 1)
        self.file_path = kwargs.get("file_path", "files")
        self.new_file_path = kwargs.get("new_file_path", "tmp")
        self.override_tempdir = kwargs.get("override_tempdir", "True")
        self.shared_home_dir = kwargs.get("shared_home_dir", None)
        self.openid_consumer_cache_path = kwargs.get("openid_consumer_cache_path", "openid_consumer_cache")
        self.cookie_path = kwargs.get("cookie_path", None)
        self.enable_quotas = kwargs.get('enable_quotas', False)
        self.enable_unique_workflow_defaults = kwargs.get('enable_unique_workflow_defaults', False)
        self.tool_path = kwargs.get("tool_path", "tools")
        self.tool_data_path = kwargs.get("tool_data_path", "tool-data")
        ...
        self.integrated_tool_panel_tracking_directory = kwargs.get('integrated_tool_panel_tracking_directory', None)
        self.toolbox_filter_base_modules = kwargs.get("toolbox_filter_base_modules", "galaxy.tools.filters,galaxy.tools.toolbox.filters")
        self.tool_filters = kwargs.get("tool_filters", [])  # TODO: mutable default!
        self.tool_label_filters = kwargs.get("tool_label_filters", []) # TODO: mutable default!
        self.tool_section_filters = kwargs.get("tool_section_filters", []) # TODO: mutable default!
        self.user_tool_filters = kwargs.get("user_tool_filters", []) # TODO: mutable default!
        self.user_tool_label_filters = kwargs.get("user_tool_label_filters", []) # TODO: mutable default!
        self.user_tool_section_filters = kwargs.get("user_tool_section_filters", []) # TODO: mutable default!
        self.tour_config_dir = kwargs.get("tour_config_dir", "config/plugins/tours")
        self.webhooks_dirs = kwargs.get("webhooks_dir", "config/plugins/webhooks")
        self.expose_user_name = kwargs.get("expose_user_name", False)
        self.expose_user_email = kwargs.get("expose_user_email", False)
        self.password_expiration_period = kwargs.get("password_expiration_period", 0)
        self.check_migrate_tools = kwargs.get('check_migrate_tools', False)
        self.shed_tool_data_path = kwargs.get("shed_tool_data_path", None)
        self.x_frame_options = kwargs.get("x_frame_options", "SAMEORIGIN")
        self.manage_dependency_relationships = kwargs.get('manage_dependency_relationships', False)
        self.running_functional_tests = kwargs.get('running_functional_tests', False)
        self.hours_between_check = kwargs.get('hours_between_check', 12)
        self.enable_tool_shed_check = kwargs.get('enable_tool_shed_check', False)
        self.update_integrated_tool_panel = kwargs.get("update_integrated_tool_panel", True)
        self.enable_data_manager_user_view = kwargs.get("enable_data_manager_user_view", "False")
        self.tool_secret = kwargs.get("tool_secret", "")
        self.id_secret = kwargs.get("id_secret", "USING THE DEFAULT IS NOT SECURE!")
        self.retry_metadata_internally = kwargs.get("retry_metadata_internally", "True")
        self.max_metadata_value_size = kwargs.get("max_metadata_value_size", 5242880)
        ...
        self.normalize_remote_user_email = kwargs.get("normalize_remote_user_email", "False")
        ...
        self.require_login = kwargs.get("require_login", "False")
        self.allow_user_creation = kwargs.get("allow_user_creation", "True")
        self.allow_user_deletion = kwargs.get("allow_user_deletion", "False")
        self.allow_user_dataset_purge = kwargs.get("allow_user_dataset_purge", "True")
        self.allow_user_impersonation = kwargs.get("allow_user_impersonation", "False")
        self.show_user_prepopulate_form = kwargs.get("show_user_prepopulate_form", "False")
        self.new_user_dataset_access_role_default_private = kwargs.get("new_user_dataset_access_role_default_private", "False")
        self.template_path = kwargs.get("template_path", "templates")
        self.template_cache = kwargs.get("template_cache_path", "compiled_templates")
        self.job_queue_cleanup_interval = kwargs.get("job_queue_cleanup_interval", "5")
        self.default_jobs_directory = kwargs.get("job_working_directory", "jobs_directory")
    ...
    def _process_config(self, kwargs):
        ...
        self.migrated_tools_config = resolve_path(self.migrated_tools_config, self.mutable_config_dir)
        self.shed_tool_conf = resolve_path(self.shed_tool_conf, self.mutable_config_dir)
        for name in ('migrated_tools_config', 'shed_tool_conf'):
            setattr(self, name + '_set', kwargs.get(name, None) is not None)  # TODO what does _set mean? default overwritten?
        ...
        self.database_create_tables = string_as_bool(self.database_create_tables)
        self.database_query_profiling_proxy = string_as_bool(self.database_query_profiling_proxy)
        self.slow_query_log_threshold = float(self.slow_query_log_threshold)
        self.thread_local_log = None
        if string_as_bool(self.enable_per_request_sql_debugging):
        ...
        self.database_auto_migrate = string_as_bool(self.database_auto_migrate)
        ...
        self.database_wait = string_as_bool(self.database_wait)
        # Attempts before failing
        self.database_wait_attempts = int(self.database_wait_attempts)
        # Sleep period between attepmts (seconds)
        self.database_wait_sleep = float(self.database_wait_sleep)

        # Where dataset files are stored
        self.file_path = resolve_path(self.file_path, self.data_dir)
        # new_file_path and legacy_home_dir can be overridden per destination in job_conf.
        self.new_file_path = resolve_path(self.new_file_path, self.data_dir)
        self.override_tempdir = string_as_bool(self.override_tempdir)
        if self.override_tempdir:
            tempfile.tempdir = self.new_file_path
        self.openid_consumer_cache_path = resolve_path(self.openid_consumer_cache_path, self.data_dir)
        self.enable_quotas = string_as_bool(self.enable_quotas)
        self.enable_unique_workflow_defaults = string_as_bool(self.enable_unique_workflow_defaults)
        self.tool_path = resolve_path(self.tool_path, self.root)
        self.tool_data_path = resolve_path(self.tool_data_path, os.getcwd())
        if not running_from_source and kwargs.get("tool_data_path", None) is None: # TODO ?
            self.tool_data_path = resolve_path("tool-data", self.data_dir)
        self.builds_file_path = resolve_path(kwargs.get("builds_file_path", os.path.join(self.tool_data_path, 'shared', 'ucsc', 'builds.txt')), self.root) # TODO
        self.len_file_path = resolve_path(kwargs.get("len_file_path", os.path.join(self.tool_data_path, 'shared', 'ucsc', 'chrom')), self.root) # TODO
        # Galaxy OIDC settings.
        self.oidc_config = kwargs.get("oidc_config_file", self.oidc_config_file) # TODO
        self.oidc_backends_config = kwargs.get("oidc_backends_config_file", self.oidc_backends_config_file) # TODO
        self.oidc = []
        # The value of migrated_tools_config is the file reserved for containing only those tools that have been eliminated from the distribution
        # and moved to the tool shed. It is created on demand.
        self.integrated_tool_panel_config = resolve_path(self.integrated_tool_panel_config, self.mutable_config_dir)
        if self.integrated_tool_panel_tracking_directory:
            self.integrated_tool_panel_tracking_directory = resolve_path(self.integrated_tool_panel_tracking_directory, self.root)
        else:
        ...
        self.tour_config_dir = resolve_path(self.tour_config_dir, self.root)
        self.webhooks_dirs = resolve_path(self.webhooks_dirs, self.root)
        ...
        self.check_migrate_tools = string_as_bool(self.check_migrate_tools)
        ...
        self.manage_dependency_relationships = string_as_bool(self.manage_dependency_relationships)
        self.running_functional_tests = string_as_bool(self.running_functional_tests)
        self.enable_tool_shed_check = string_as_bool(self.enable_tool_shed_check)
        ...
        try:
            ...
            self.hours_between_check = 12
        self.enable_data_manager_user_view = string_as_bool(self.enable_data_manager_user_view)
        self.galaxy_data_manager_data_path = kwargs.get('galaxy_data_manager_data_path', self.tool_data_path) # TODO
        self.retry_metadata_internally = string_as_bool(self.retry_metadata_internally)
        self.max_metadata_value_size = int(self.max_metadata_value_size)
        self.use_remote_user = string_as_bool(self.use_remote_user) or self.single_user
        self.normalize_remote_user_email = string_as_bool(self.normalize_remote_user_email)
        self.require_login = string_as_bool(self.require_login)
        self.fetch_url_whitelist_ips = [
            ...
            for ip in kwargs.get("fetch_url_whitelist", "").split(',')   # TODO
            if len(ip.strip()) > 0
        ]
        self.allow_user_creation = string_as_bool(self.allow_user_creation)
        self.allow_user_deletion = string_as_bool(self.allow_user_deletion)
        self.allow_user_dataset_purge = string_as_bool(self.allow_user_dataset_purge)
        self.allow_user_impersonation = string_as_bool(self.allow_user_impersonation)
        self.show_user_prepopulate_form = string_as_bool(self.show_user_prepopulate_form)
        self.new_user_dataset_access_role_default_private = string_as_bool(self.new_user_dataset_access_role_default_private)
        self.template_path = resolve_path(self.template_path, self.root)
        self.template_cache = resolve_path(self.template_cache, self.data_dir)
        self.job_queue_cleanup_interval = int(self.job_queue_cleanup_interval)
        self.cluster_files_directory = self.resolve_path(kwargs.get("cluster_files_directory", os.path.join(self.data_dir, "pbs"))) # TODO

        # Fall back to legacy job_working_directory config variable if set.
        self.jobs_directory = resolve_path(kwargs.get("jobs_directory", self.default_jobs_directory), self.data_dir) # TODO
