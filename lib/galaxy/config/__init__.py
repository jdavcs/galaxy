...
class ConfiguresGalaxyMixin:
    ...
    def _configure_models(self, check_migrate_databases=False, check_migrate_tools=False, config_file=None):
        ...
        if check_migrate_databases:
            from galaxy.model.migrations import DatabaseVerifier
            dbv = DatabaseVerifier(engine, install_engine, self.config)
            dbv.verify()

            # TODO: Improve: can we implement these in revisions?
        ...
        self.model = mapping.init(
            ...
            use_pbkdf2=self.config.use_pbkdf2,
        ...
        if combined_install_database:
            ...
            self.install_model = install_mapping.init(install_engine)
