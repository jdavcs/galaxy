...
class GalaxyAppConfiguration(BaseAppConfiguration):
    ...
    def _process_config(self, kwargs):
        ...
        self.migrated_tools_config = os.path.join(self.mutable_config_dir, self.migrated_tools_config)
        self.shed_tool_conf = os.path.join(self.mutable_config_dir, kwargs.get('shed_tool_conf', 'shed_tool_conf.xml'))
