...
class Jobs(BaseUIController, ReportQueryBuilder):
    ...
    def job_info(self, trans, **kwd):
        message = ""
        job = JobRepository(trans.sa_session, model.Job).get(trans.security.decode_id(kwd.get("id", "")))
...
def get_job(trans, id):
    return JobRepository(trans.sa_session, trans.model.Job).get(trans.security.decode_id(id))
