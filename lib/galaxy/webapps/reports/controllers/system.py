...
from galaxy.model.repositories.dataset import DatasetRepository
...
class System(BaseUIController):
    ...
    def dataset_info(self, trans, **kwd):
        message = ""
        dataset = DatasetRepository(trans.sa_session, model.Dataset).get(trans.security.decode_id(kwd.get("id", "")))
