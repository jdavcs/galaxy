...
from tool_shed.managers.repositories import (
    ...
    create_repository,
    get_install_info,
    get_ordered_installable_revisions as do_get_ordered_installable_revisions,
    get_repository_metadata_dict,
    get_repository_metadata_for_management,
    index_repositories,
    readmes,
    reset_metadata_on_repository as do_reset_metadata_on_repository,
    search,
    to_detailed_model,
    to_model,
    UpdatesRequest,
...
def get_ordered_installable_revisions(
    ...
    return do_get_ordered_installable_revisions(app, name, owner, tsr_id)
...
def reset_metadata_on_repository_legacy(
    trans: SessionRequestContext = DependsOnTrans,
    request: ResetMetadataOnRepositoryRequest = depend_on_either_json_or_form_data(ResetMetadataOnRepositoryRequest),
) -> ResetMetadataOnRepositoryResponse:
    return do_reset_metadata_on_repository(trans, request.repository_id)
...
def reset_metadata_on_repository(
    ...
    return do_reset_metadata_on_repository(trans, encoded_repository_id)
